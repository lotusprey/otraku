...
abstract class AppLocalizations {
  ...
  /// No description provided for @actionOpenVideoInBrowser.
  ///
  /// In en, this message translates to:
  /// **'Open Video in Browser'**
  String get actionOpenVideoInBrowser;
  ...
  /// No description provided for @actionRemoveQuestion.
  ///
  /// In en, this message translates to:
  /// **'Remove?'**
  String get actionRemoveQuestion;
  ...
  /// No description provided for @compositionsAdd.
  ///
  /// In en, this message translates to:
  /// **'Compose'**
  String get compositionsAdd;

  /// No description provided for @compositionsPreview.
  ///
  /// In en, this message translates to:
  /// **'Preview'**
  String get compositionsPreview;
  ...
  /// No description provided for @errorFailedGettingFile.
  ///
  /// In en, this message translates to:
  /// **'Failed getting file'**
  String get errorFailedGettingFile;
  ...
  /// Failed http update updating
  ///
  /// In en, this message translates to:
  /// **'Failed Updating: {error}'**
  String errorFailedUpdating(String error);

  /// No description provided for @errorMissingGalleryPermission.
  ///
  /// In en, this message translates to:
  /// **'Missing gallery permission'**
  String get errorMissingGalleryPermission;
  ...
  /// No description provided for @errorUriInvalid.
  ///
  /// In en, this message translates to:
  /// **'Invalid URI'**
  String get errorUriInvalid;
  ...
  /// How many people have favrited an item
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @filterSubscribed.
  ///
  /// In en, this message translates to:
  /// **'Subscribed'**
  String get filterSubscribed;
  ...
  /// No description provided for @notificationsFilterReplies.
  ///
  /// In en, this message translates to:
  /// **'Replies'**
  String get notificationsFilterReplies;
  ...
  /// No description provided for @notificationsFilterForum.
  ///
  /// In en, this message translates to:
  /// **'Forum'**
  String get notificationsFilterForum;

  /// No description provided for @notificationsFilterAiring.
  ///
  /// In en, this message translates to:
  /// **'Airing'**
  String get notificationsFilterAiring;

  /// No description provided for @notificationsFilterFollows.
  ///
  /// In en, this message translates to:
  /// **'Follows'**
  String get notificationsFilterFollows;

  /// No description provided for @notificationsFilterMedia.
  ///
  /// In en, this message translates to:
  /// **'Media'**
  String get notificationsFilterMedia;

  /// No description provided for @notificationsTypeActivityLikes.
  ///
  /// In en, this message translates to:
  /// **'Activity likes'**
  String get notificationsTypeActivityLikes;

  /// No description provided for @notificationsTypeActivityMentions.
  ///
  /// In en, this message translates to:
  /// **'Activity mentions'**
  String get notificationsTypeActivityMentions;

  /// No description provided for @notificationsTypeActivityReplies.
  ///
  /// In en, this message translates to:
  /// **'Activity replies'**
  String get notificationsTypeActivityReplies;

  /// No description provided for @notificationsTypeActivityRepliesLikes.
  ///
  /// In en, this message translates to:
  /// **'Activity reply likes'**
  String get notificationsTypeActivityRepliesLikes;

  /// No description provided for @notificationsTypeActivityRepliesSubscribed.
  ///
  /// In en, this message translates to:
  /// **'Subscribed activity replies'**
  String get notificationsTypeActivityRepliesSubscribed;

  /// No description provided for @notificationsTypeFollows.
  ///
  /// In en, this message translates to:
  /// **'Follows'**
  String get notificationsTypeFollows;

  /// No description provided for @notificationsTypeMediaAdditions.
  ///
  /// In en, this message translates to:
  /// **'Related media additions'**
  String get notificationsTypeMediaAdditions;

  /// No description provided for @notificationsTypeMediaAiring.
  ///
  /// In en, this message translates to:
  /// **'Episode releases'**
  String get notificationsTypeMediaAiring;

  /// No description provided for @notificationsTypeMediaChanges.
  ///
  /// In en, this message translates to:
  /// **'Media changes'**
  String get notificationsTypeMediaChanges;

  /// No description provided for @notificationsTypeMediaDeletions.
  ///
  /// In en, this message translates to:
  /// **'Media deletions'**
  String get notificationsTypeMediaDeletions;

  /// No description provided for @notificationsTypeMediaMerges.
  ///
  /// In en, this message translates to:
  /// **'Media merges'**
  String get notificationsTypeMediaMerges;

  /// No description provided for @notificationsTypeMessages.
  ///
  /// In en, this message translates to:
  /// **'Messages'**
  String get notificationsTypeMessages;

  /// No description provided for @notificationsTypeSubmissionsUpdatesCharacter.
  ///
  /// In en, this message translates to:
  /// **'Character submission updates'**
  String get notificationsTypeSubmissionsUpdatesCharacter;

  /// No description provided for @notificationsTypeSubmissionsUpdatesMedia.
  ///
  /// In en, this message translates to:
  /// **'Media submission updates'**
  String get notificationsTypeSubmissionsUpdatesMedia;

  /// No description provided for @notificationsTypeSubmissionsUpdatesStaff.
  ///
  /// In en, this message translates to:
  /// **'Staff submission updates'**
  String get notificationsTypeSubmissionsUpdatesStaff;

  /// No description provided for @notificationsTypeThreadComments.
  ///
  /// In en, this message translates to:
  /// **'Thread comments'**
  String get notificationsTypeThreadComments;

  /// No description provided for @notificationsTypeThreadCommentsLikes.
  ///
  /// In en, this message translates to:
  /// **'Thread comment likes'**
  String get notificationsTypeThreadCommentsLikes;

  /// No description provided for @notificationsTypeThreadLikes.
  ///
  /// In en, this message translates to:
  /// **'Thread likes'**
  String get notificationsTypeThreadLikes;

  /// No description provided for @notificationsTypeThreadMentions.
  ///
  /// In en, this message translates to:
  /// **'Thread mentions'**
  String get notificationsTypeThreadMentions;

  /// No description provided for @notificationsTypeThreadRepliesSubscribed.
  ///
  /// In en, this message translates to:
  /// **'Subscribed thread replies'**
  String get notificationsTypeThreadRepliesSubscribed;
  ...
  /// No description provided for @pagesNext.
  ///
  /// In en, this message translates to:
  /// **'Next Page'**
  String get pagesNext;

  /// No description provided for @pagesPrevious.
  ///
  /// In en, this message translates to:
  /// **'Previous Page'**
  String get pagesPrevious;
  ...
  /// No description provided for @postsAddMessage.
  ///
  /// In en, this message translates to:
  /// **'New Message'**
  String get postsAddMessage;
  ...
  /// No description provided for @postsPinnedAdd.
  ///
  /// In en, this message translates to:
  /// **'Pin'**
  String get postsPinnedAdd;

  /// No description provided for @postsPinnedRemove.
  ///
  /// In en, this message translates to:
  /// **'Unpin'**
  String get postsPinnedRemove;
  ...
  /// No description provided for @postsRepliesAdd.
  ///
  /// In en, this message translates to:
  /// **'Reply'**
  String get postsRepliesAdd;
  ...
  /// Ranking based on popularity of all time
  ///
  /// In en, this message translates to:
  /// **'#{rank} Highest Rated Ever'**
  String rankHighestRatedAllTime(int rank);

  /// Ranking based on highest rating of a given season and year
  ///
  /// In en, this message translates to:
  /// **'#{rank} Highest Rated {season} {year}'**
  String rankHighestRatedSeasonYear(int rank, int year, String season);

  /// Ranking based on highest rating of a given year
  ///
  /// In en, this message translates to:
  /// **'#{rank} Highest Rated {year}'**
  String rankHighestRatedYear(int rank, int year);

  /// No description provided for @rankMostPopularAllTime.
  ///
  /// In en, this message translates to:
  /// **'#{rank} Most Popular Ever'**
  String rankMostPopularAllTime(Object rank);

  /// Ranking based on popularity of a given season and year
  ///
  /// In en, this message translates to:
  /// **'#{rank} Most Popular {season} {year}'**
  String rankMostPopularSeasonYear(int rank, int year, String season);

  /// Ranking based on popularity of a given year
  ///
  /// In en, this message translates to:
  /// **'#{rank} Most Popular {year}'**
  ...
  /// No description provided for @recommendationsSortHighestRated.
  ///
  /// In en, this message translates to:
  /// **'Highest Rated'**
  String get recommendationsSortHighestRated;

  /// No description provided for @recommendationsSortLowestRated.
  ///
  /// In en, this message translates to:
  /// **'Lowest Rated'**
  String get recommendationsSortLowestRated;

  /// No description provided for @recommendationsSortNewest.
  ///
  /// In en, this message translates to:
  /// **'Newest'**
  String get recommendationsSortNewest;
  ...
  /// No description provided for @statisticsAnime.
  ///
  /// In en, this message translates to:
  /// **'Anime Statistics'**
  String get statisticsAnime;

  /// No description provided for @statisticsChaptersRead.
  ///
  /// In en, this message translates to:
  /// **'Chapters Read'**
  String get statisticsChaptersRead;

  /// No description provided for @statisticsDaysWatched.
  ///
  /// In en, this message translates to:
  /// **'Days Watched'**
  String get statisticsDaysWatched;

  /// No description provided for @statisticsDistributionCountry.
  ///
  /// In en, this message translates to:
  /// **'Country Distribution'**
  String get statisticsDistributionCountry;

  /// No description provided for @statisticsDistributionFormat.
  ///
  /// In en, this message translates to:
  /// **'Format Distribution'**
  String get statisticsDistributionFormat;

  /// No description provided for @statisticsDistributionScore.
  ///
  /// In en, this message translates to:
  /// **'Score Distribution'**
  String get statisticsDistributionScore;

  /// No description provided for @statisticsDistributionStatus.
  ///
  /// In en, this message translates to:
  /// **'Status Distribution'**
  String get statisticsDistributionStatus;

  /// No description provided for @statisticsEpisodesWatched.
  ///
  /// In en, this message translates to:
  /// **'Episodes Watched'**
  String get statisticsEpisodesWatched;

  /// No description provided for @statisticsHours.
  ///
  /// In en, this message translates to:
  /// **'Hours'**
  String get statisticsHours;

  /// No description provided for @statisticsManga.
  ///
  /// In en, this message translates to:
  /// **'Manga Statistics'**
  String get statisticsManga;

  /// No description provided for @statisticsStandardDeviation.
  ///
  /// In en, this message translates to:
  /// **'Standard Deviation'**
  String get statisticsStandardDeviation;

  /// No description provided for @statisticsTitles.
  ///
  /// In en, this message translates to:
  /// **'Titles'**
  String get statisticsTitles;

  /// No description provided for @statisticsTotalAnime.
  ///
  /// In en, this message translates to:
  /// **'Total Anime'**
  String get statisticsTotalAnime;

  /// No description provided for @statisticsTotalManga.
  ///
  /// In en, this message translates to:
  /// **'Total Manga'**
  String get statisticsTotalManga;

  /// No description provided for @statisticsVolumesRead.
  ///
  /// In en, this message translates to:
  /// **'Volumes Read'**
  String get statisticsVolumesRead;
  ...
  /// No description provided for @subscriptionsRemove.
  ///
  /// In en, this message translates to:
  /// **'Unsubscribe'**
  String get subscriptionsRemove;
