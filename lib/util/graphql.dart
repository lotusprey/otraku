abstract class GqlQuery {
  ...
  static const mediaPage = r'''
    query Media($page: Int, $type: MediaType, $search:String, $status_in: [MediaStatus],
        ...
        $sources: [MediaSource], $isAdult: Boolean, $isLicensed: Boolean, $licensor_id_in: [Int], $sort: [MediaSort]) {
      Page(page: $page) {
        pageInfo {hasNextPage}
        ...
        isLicensed: $isLicensed, licensedById_in: $licensor_id_in, countryOfOrigin: $countryOfOrigin, season: $season,
